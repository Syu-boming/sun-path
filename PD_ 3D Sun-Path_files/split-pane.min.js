...
!(function (t) {
                ...
                s = t.children(".split-pane-component:last")[0];
              {
                ...
                if (t.is(".horizontal-percent")) {
                  ...
                  return function (r) {
                    ...
                    s.offsetHeight > o
                      ? h(i, n, s, (o / e.offsetHeight) * 100 + "%")
                      : e.offsetHeight - i.offsetHeight - n.offsetHeight < f &&
                        h(i, n, s, (f / e.offsetHeight) * 100 + "%"),
                      t.resize();
                  };
                }
                if (t.is(".fixed-left")) {
                ...
                if (t.is(".vertical-percent")) {
                  ...
                  return function (f) {
                    var r = e.offsetWidth - l - n.offsetWidth;
                    s.offsetWidth > r
                      ? d(i, n, s, (r / e.offsetWidth) * 100 + "%")
                      : e.offsetWidth - i.offsetWidth - n.offsetWidth < u &&
                        d(i, n, s, (u / e.offsetWidth) * 100 + "%"),
                      t.resize();
                  };
                }
              }
  ...
  function i() {
    ...
    e.is(".fixed-top, .fixed-bottom, .horizontal-percent")
      ? e.css("min-height", r(i) + r(s) + n.height() + "px")
      : e.css("min-width", o(i) + o(s) + n.width() + "px");
  }
  function n(e) {
    e.preventDefault();
  ...
  jQuery.event.special._splitpaneparentresize = {
    setup: function (i, n) {
      ...
      t(this).data(e, function (t) {
        (t.target === document ? window : t.target) === f
          ? ((t.type = "_splitpaneparentresize"),
            jQuery.event.dispatch.apply(s, arguments))
          : t.stopPropagation();
      }),
