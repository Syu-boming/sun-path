  ...
  (this.L.Control.Geocoder = (function (d) {
      ...
      for (var n in e) {
        ...
        if (d.Util.isArray(r))
          for (var a = 0; a < r.length; a++)
            s.push(i + "=" + encodeURIComponent(r[a]));
    ...
    var c = d.Class.extend({
      ...
      geocode: function (e, r, a) {
        ...
        this._key && this._key.length && (t.token = this._key),
          u(
            ...
            d.extend(t, this.options.geocodingQueryParams),
            function (e) {
              var t,
                o,
                s,
              ...
              if (e.candidates && e.candidates.length)
                for (var i = 0; i <= e.candidates.length - 1; i++)
                  (t = e.candidates[i]),
                    ...
                    (s = d.latLngBounds(
                      d.latLng(t.extent.ymax, t.extent.xmax),
                      d.latLng(t.extent.ymin, t.extent.xmin)
                    )),
      ...
      reverse: function (e, t, s, n) {
        ...
        u(this.options.service_url + "/reverseGeocode", o, function (e) {
          ...
          e &&
            !e.error &&
            ((t = d.latLng(e.location.y, e.location.x)),
            o.push({
    ...
    var p = d.Class.extend({
        ...
        o(
          ...
          function (e) {
            ...
            if (0 < e.resourceSets.length)
              for (
                var o = e.resourceSets[0].resources.length - 1;
                0 <= o;
                o--
              ) {
      ...
      reverse: function (e, t, i, r) {
        o(
          ...
          function (e) {
            for (
              var t = [], o = e.resourceSets[0].resources.length - 1;
              0 <= o;
              o--
            ) {
              var s = e.resourceSets[0].resources[o],
            ...
            if (e.results && e.results.length)
              for (var i = 0; i <= e.results.length - 1; i++)
                (t = e.results[i]),
                  ...
                  (s = d.latLngBounds(
                    d.latLng(t.geometry.viewport.northeast),
                    d.latLng(t.geometry.viewport.southwest)
                  )),
                  (n[i] = {
    ...
    var g = d.Class.extend({
      ...
      geocode: function (e, t, o) {
        ...
        (s = d.Util.extend(s, this.options.geocodingQueryParams)),
          this.getJSON(this.options.geocodeUrl, s, t, o);
      },
      reverse: function (e, t, o, s) {
        ...
        (n = d.Util.extend(n, this.options.reverseQueryParams)),
          this.getJSON(this.options.reverseGeocodeUrl, n, o, s);
      },
          ...
          if (e.response.view && e.response.view.length)
            for (var i = 0; i <= e.response.view[0].result.length - 1; i++)
              (t = e.response.view[0].result[i].location),
                (o = d.latLng(
                  t.displayPosition.latitude,
                  t.displayPosition.longitude
                )),
                (s = d.latLngBounds(
                  d.latLng(
                    t.mapView.topLeft.latitude,
                    t.mapView.topLeft.longitude
                  ),
                  d.latLng(
                    t.mapView.bottomRight.latitude,
                    t.mapView.bottomRight.longitude
                  )
                )),
      ...
      geocode: function (e, t, o) {
        ...
        if (
          ((s = e.match(
            ...
            ? (n = d.latLng(
                (/N/i.test(s[1]) ? 1 : -1) * parseFloat(s[2]),
                (/E/i.test(s[3]) ? 1 : -1) * parseFloat(s[4])
              ))
            : (s = e.match(
                /^(\d{1,3}(?:\.\d*)?)\s*([NS])\W*(\d{1,3}(?:\.\d*)?)\s*([EW])$/
              ))
            ? (n = d.latLng(
                (/N/i.test(s[2]) ? 1 : -1) * parseFloat(s[1]),
                (/E/i.test(s[4]) ? 1 : -1) * parseFloat(s[3])
              ))
            : (s = e.match(
            ...
            ? (n = d.latLng(
                (/N/i.test(s[1]) ? 1 : -1) *
                  (parseFloat(s[2]) + parseFloat(s[3] / 60)),
                (/E/i.test(s[4]) ? 1 : -1) *
                  (parseFloat(s[5]) + parseFloat(s[6] / 60))
              ))
            : (s = e.match(
            ...
            ? (n = d.latLng(
                (/N/i.test(s[3]) ? 1 : -1) *
                  (parseFloat(s[1]) + parseFloat(s[2] / 60)),
                (/E/i.test(s[6]) ? 1 : -1) *
                  (parseFloat(s[4]) + parseFloat(s[5] / 60))
              ))
            : (s = e.match(
            ...
            ? (n = d.latLng(
                (/N/i.test(s[1]) ? 1 : -1) *
                  (parseFloat(s[2]) +
                    parseFloat(s[3] / 60 + parseFloat(s[4] / 3600))),
                (/E/i.test(s[5]) ? 1 : -1) *
                  (parseFloat(s[6]) +
                    parseFloat(s[7] / 60) +
                    parseFloat(s[8] / 3600))
            ...
            ? (n = d.latLng(
                (/N/i.test(s[4]) ? 1 : -1) *
                  (parseFloat(s[1]) +
                    parseFloat(s[2] / 60 + parseFloat(s[3] / 3600))),
                (/E/i.test(s[8]) ? 1 : -1) *
                  (parseFloat(s[5]) +
                    parseFloat(s[6] / 60) +
                    parseFloat(s[7] / 3600))
            ...
            : (s = e.match(
                /^\s*([+-]?\d+(?:\.\d*)?)\s*[\s,]\s*([+-]?\d+(?:\.\d*)?)\s*$/
              )) && (n = d.latLng(parseFloat(s[1]), parseFloat(s[2]))),
          n)
        ) {
          var i = [
            { name: e, center: n, bbox: n.toBounds(this.options.sizeInMeters) },
          ];
          t.call(o, i);
    ...
    var f = d.Class.extend({
      ...
      geocode: function (e, l, c) {
        ...
        void 0 !== t.proximity &&
          void 0 !== t.proximity.lat &&
          void 0 !== t.proximity.lng &&
          (t.proximity = t.proximity.lng + "," + t.proximity.lat),
          u(
            this.options.serviceUrl + encodeURIComponent(e) + ".json",
            t,
            function (e) {
              var t,
                o,
              ...
              if (e.features && e.features.length)
                for (var i = 0; i <= e.features.length - 1; i++) {
                  (t = e.features[i]),
                    ...
                    (s = t.bbox
                      ? d.latLngBounds(
                          d.latLng(t.bbox.slice(0, 2).reverse()),
                          d.latLng(t.bbox.slice(2, 4).reverse())
                        )
                      : d.latLngBounds(o, o));
                  for (
                    var r = { text: t.text, address: t.address }, a = 0;
                    a < (t.context || []).length;
                    a++
                  ) {
        ...
        u(
          ...
          function (e) {
            ...
            e.locations &&
              ...
              (t = d.latLng(e.geometry.latitude, e.geometry.longitude)),
              (o = d.latLngBounds(t, t)),
              (s[0] = { name: e.geometry.address, bbox: o, center: t })),
              n.call(i, s);
          }
        );
      },
      ...
      reverse: function (n, e, i, r) {
        u(
          ...
          function (e) {
            ...
            200 == e.status.status &&
              e.found &&
              ((t = d.latLng(n.lat, n.lng)),
              (o = d.latLngBounds(t, t)),
              (s[0] = { name: e.address, bbox: o, center: t })),
              i.call(r, s);
          }
        );
      },
    ...
    var b = d.Class.extend({
      ...
      geocode: function (e, i, r) {
        u(
          ...
          d.extend(
            { q: e, limit: 5, format: "json", addressdetails: 1 },
            this.options.geocodingQueryParams
          ),
          d.bind(function (e) {
            for (var t = [], o = e.length - 1; 0 <= o; o--) {
              for (var s = e[o].boundingbox, n = 0; n < 4; n++)
                s[n] = parseFloat(s[n]);
              t[o] = {
                icon: e[o].icon,
                name: e[o].display_name,
                html: this.options.htmlTemplate
                  ? this.options.htmlTemplate(e[o])
                  : void 0,
        ...
        u(
          ...
          d.bind(function (e) {
            ...
            e &&
              e.lat &&
              e.lon &&
              ((t = d.latLng(e.lat, e.lon)),
              o.push({
                name: e.display_name,
                html: this.options.htmlTemplate
                  ? this.options.htmlTemplate(e)
                  : void 0,
                center: t,
                bounds: d.latLngBounds(t, t),
                properties: e,
        ...
        try {
          var s = this.options.OpenLocationCode.decode(e),
            n = {
              ...
              bbox: d.latLngBounds(
                d.latLng(s.latitudeLo, s.longitudeLo),
                d.latLng(s.latitudeHi, s.longitudeHi)
              ),
            };
          t.call(o, [n]);
        } catch (e) {
    ...
    var y = d.Class.extend({
            ...
            if (e.results && e.results.length)
              for (var i = 0; i < e.results.length; i++)
                (s = e.results[i]),
                  ...
                  (o =
                    s.annotations && s.annotations.bounds
                      ? d.latLngBounds(
                          d.latLng(s.annotations.bounds.northeast),
                          d.latLng(s.annotations.bounds.southwest)
                        )
                      : d.latLngBounds(t, t)),
      ...
      reverse: function (e, t, r, a) {
        u(
          this.options.serviceUrl,
          { key: this._accessToken, q: [e.lat, e.lng].join(",") },
          function (e) {
            var t,
              o,
              s,
    ...
    var x = d.Class.extend({
      ...
      suggest: function (e, t, o) {
        ...
        u(
          ...
          d.bind(function (e) {
            e.geocoding.timestamp > this._lastSuggest &&
              ((this._lastSuggest = e.geocoding.timestamp),
              t.call(o, s._parseResults(e, "bbox")));
          }, this)
        );
      },
      reverse: function (e, t, o, s) {
        ...
        u(
          this.options.serviceUrl + "/reverse",
          d.extend(
            { api_key: this._apiKey, "point.lat": e.lat, "point.lon": e.lng },
            this.options.reverseQueryParams
          ),
          function (e) {
            ...
            onEachFeature: function (e, t) {
              ...
              t.getBounds
                ...
                : (o = t.feature.bbox
                    ? ((s = t.getLatLng()),
                      d.latLngBounds(
                        d.GeoJSON.coordsToLatLng(t.feature.bbox.slice(0, 2)),
                        d.GeoJSON.coordsToLatLng(t.feature.bbox.slice(2, 4))
                      ))
        ...
        if (e && e.features)
          for (t = 0; t < e.features.length; t++)
            (s = (o = e.features[t]).geometry.coordinates),
              (n = d.latLng(s[1], s[0])),
              (r = (i = o.properties.extent)
                ? d.latLngBounds([i[1], i[0]], [i[3], i[2]])
                : d.latLngBounds(n, n)),
              a.push({
    ...
    var T = d.Class.extend({
      ...
      geocode: function (e, n, i) {
        u(
          ...
          { key: this._accessToken, addr: e.split(/\s+/).join(".") },
          function (e) {
            var t,
              o,
              s = [];
            e.geometry &&
              ((t = d.latLng(e.geometry.lat, e.geometry.lng)),
              (o = d.latLngBounds(t, t)),
              (s[0] = { name: e.words, bbox: o, center: t })),
              n.call(i, s);
          }
        );
      },
      ...
      reverse: function (e, t, n, i) {
        u(
          this.options.serviceUrl + "reverse",
          { key: this._accessToken, coords: [e.lat, e.lng].join(",") },
          function (e) {
            var t,
              o,
              s = [];
    ...
    var B = Object.freeze({
      ...
      R = d.Control.extend({
        ...
        initialize: function (e) {
          d.Util.setOptions(this, e),
            this.options.geocoder || (this.options.geocoder = new b()),
        ...
        onAdd: function (e) {
          ...
          return (
            ...
            (n.innerHTML = "&nbsp;"),
            (n.type = "button"),
            ((t = this._input = d.DomUtil.create("input", "", i)).type =
              "text"),
            (t.placeholder = this.options.placeholder),
            d.DomEvent.disableClickPropagation(t),
            (this._errorElement = d.DomUtil.create(
              "div",
              o + "-form-no-error",
              s
            )),
            (this._errorElement.innerHTML = this.options.errorMessage),
            (this._alts = d.DomUtil.create(
              "ul",
              o +
            ...
            this.options.geocoder.suggest &&
              d.DomEvent.addListener(t, "input", this._change, this),
            ...
            this.options.collapsed
              ? "click" === this.options.expand
                ...
                : (d.DomEvent.addListener(s, "mouseover", this._expand, this),
                  d.DomEvent.addListener(s, "mouseout", this._collapse, this),
        ...
        _geocodeResult: function (e, t) {
          if (!t && this.options.showUniqueResult && 1 === e.length)
            ...
            for (var o = 0; o < e.length; o++)
              this._alts.appendChild(this._createAlt(e[o], o));
          } else
            d.DomUtil.addClass(
              this._container,
          ...
          if (t || !(e.length < this.options.queryMinLength)) {
            ...
            (this._lastGeocode = e),
              ...
              this.options.geocoder[s](
                e,
                function (e) {
                  o === this._requestCount &&
                    ((n.results = e),
                    this.fire("finish" + s, n),
                    this._geocodeResult(e, t));
                },
                this
              );
          }
          ...
          var t = this,
            o = function (e) {
              t._selection &&
                ...
                (t._selection =
                  t._selection[0 < e ? "nextSibling" : "previousSibling"])),
                t._selection ||
                  (t._selection = t._alts[0 < e ? "firstChild" : "lastChild"]),
                t._selection &&
                  d.DomUtil.addClass(
                    t._selection,
                    "leaflet-control-geocoder-selected"
